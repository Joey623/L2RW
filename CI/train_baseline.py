...
parser.add_argument('--method', default='baseline', help='dataset name: regdb or sysu')
parser.add_argument('--lr', default=0.2, type=float, help='learning rate, 0.00035 for adam, 0.0009for adamw, 0.1 for sgd')
...
# suffix = 'flvireid'
suffix = args.method
suffix = suffix + '_{}_p{}_n{}_lr{}_{}_seed_{}'.format(args.dataset, args.batch_size, args.num_pos, args.lr, args.optim, args.seed)
if dataset == 'regdb':
...
for epoch in range(start_epoch, args.max_epoch):
    ...
    for index in range(len(train_set)):
        ...
        w = train(epoch, client_optimizer[index], net=net[index], args=args, global_weight=global_weight)
