...
class opts:
    def __init__(self):
        ...
        self.parser.add_argument('--data_root', type=str, default='$LOCAL_SCRATCH/DATA')
        self.parser.add_argument('--save_dir', type=str, default='/scratch/project_2005312/yan/ReID/L2RW+/Extend/video/bupt/save/')
        self.parser.add_argument('--fake', action='store_true', default=False)
        self.parser.add_argument('--feature_postfix', type=str, default='uniform')
        ...
        self.parser.add_argument('--lr', type=float, default=0.2)
        self.parser.add_argument('--lr_multipliers', default=[0.1, 1.0, 1.0])
        ...
        self.parser.add_argument('--warm_up_epoch', type=int, default=8)
        self.parser.add_argument('--decay_step', type=int, default=16)
        ...
        self.parser.add_argument('--train_sampler_nc', type=int, default=1)
        ...
        self.parser.add_argument('--auxiliary_sampler_nc', type=int, default=1)
