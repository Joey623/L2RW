...
def protocol_decoder(protocol):
    ...
    elif protocol == "S_to_S":
        data_name_list_train = ["SYSU"]
        data_name_list_test = ["SYSU"]
    elif protocol == "S_to_R":
        data_name_list_train = ["SYSU"]
        data_name_list_test = ["RegDB"]
    elif protocol == "S_to_L":
        data_name_list_train = ["SYSU"]
        data_name_list_test = ["LLCM"]
    elif protocol == "R_to_R":
        data_name_list_train = ["RegDB"]
        data_name_list_test = ["RegDB"]
    elif protocol == "R_to_S":
        data_name_list_train = ["RegDB"]
        data_name_list_test = ["SYSU"]
    elif protocol == "R_to_L":
        data_name_list_train = ["RegDB"]
        data_name_list_test = ["LLCM"]
    elif protocol == "L_to_L":
        data_name_list_train = ["LLCM"]
        data_name_list_test = ["LLCM"]
    elif protocol == "L_to_R":
        data_name_list_train = ["LLCM"]
        data_name_list_test = ["RegDB"]
    elif protocol == "L_to_S":
        data_name_list_train = ["LLCM"]
        data_name_list_test = ["SYSU"]
    elif protocol == "R_L_S_to_L":
        data_name_list_train = ["RegDB", "LLCM", "SYSU"]
        data_name_list_test = ["LLCM"]
    elif protocol == "R_L_S_to_R":
        data_name_list_train = ["RegDB", "LLCM", "SYSU"]
        data_name_list_test = ["RegDB"]
    elif protocol == "R_L_S_to_S":
        data_name_list_train = ["RegDB", "LLCM", "SYSU"]
        data_name_list_test = ["SYSU"]
