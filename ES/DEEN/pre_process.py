...
def preprocess_sysu(data_path, protocol, width=144, height=384, add=0):
...
def preprocess_llcm(data_path, protocol, width=144, height=384, add=0):
...
def preprocess_regdb(data_path, protocol, width=144, height=384, trial=1):
...
if __name__ == '__main__':
    ...
    protocol = "R_S_to_L"
    preprocess_sysu(sysu_data_path, protocol, width=144, height=384, add=206)
    preprocess_llcm(llcm_data_path, protocol, width=144, height=384, add=0)
    preprocess_regdb(regdb_data_path, protocol, width=144, height=384, trial=1)

    protocol = "R_L_to_S"
    preprocess_sysu(sysu_data_path, protocol, width=144, height=384, add=0)
    preprocess_llcm(llcm_data_path, protocol, width=144, height=384, add=206)
    preprocess_regdb(regdb_data_path, protocol, width=144, height=384, trial=1)

    protocol = "L_S_to_R"
    preprocess_sysu(sysu_data_path, protocol, width=144, height=384, add=713)
    preprocess_llcm(llcm_data_path, protocol, width=144, height=384, add=0)
    preprocess_regdb(regdb_data_path, protocol, width=144, height=384, trial=1)
    ...
    #
    # protocol = "R_L_S_to_L"
    # preprocess_sysu(sysu_data_path, protocol, width=144, height=384, add=919)
    # preprocess_llcm(llcm_data_path, protocol, width=144, height=384, add=206)
    # preprocess_regdb(regdb_data_path, protocol, width=144, height=384, trial=1)
    #
    # protocol = "R_L_S_to_R"
