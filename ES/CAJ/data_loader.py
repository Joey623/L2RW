...
class MultiVIReIDDataset(data.Dataset):
    def __init__(self, args, data_dir1, data_dir2, protocol, transform=None, colorIndex=None, thermalIndex=None):
...
def get_datasets(args, MultiVIReIDDataset, transform=None):
    ...
    train_set = MultiVIReIDDataset(args, data_dir1, data_dir2, args.protocol, transform)
